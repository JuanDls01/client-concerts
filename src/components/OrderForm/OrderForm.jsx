      ...
      <div className={style.interno}>
        <div className={style.izquierda}>
          ...
          <div className={style.infoBody}>
            <span className={style.span}><strong>Event Name:</strong> {preOrder.eventName && preOrder.eventName}</span>
            <span className={style.span}><strong>Date:</strong> {preOrder.eventDate}</span>
            <span className={style.span}><strong>Ticket category:</strong> {preOrder.ticketName}</span>
            <span className={style.span}><strong>Tickets: </strong> {preOrder.ticketQ} x</span>
            <span className={style.span}><strong>Price Ticket:</strong> ${preOrder.ticketPrice}</span>
