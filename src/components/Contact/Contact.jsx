...
const validator = (input) => {
  ...
  else if (!testEmail.test(input.user_email))
    ...
    <div className={style.pageContainner}>
      ...
      <div className={style.formContainner}>
        <h1 className={style.titleForm}>
          Hello, leave us your comments, they are very important to us.{" "}
        </h1>
        <form ref={form} className={style.formContent} onSubmit={handleSubmit}>
          ...
          />
          {errors.user_name ? (
            <div className={style.error}>{errors.user_name}</div>
          ) : null}
          ...
          />
          {errors.user_email ? (
            <div className={style.error}>{errors.user_email}</div>
          ) : null}
          ...
          />
          {errors.user_subject ? (
            <div className={style.error}>{errors.user_subject}</div>
          ) : null}
          ...
          <button className={style.button2} onClick={() => navigate("/")}>
            Cancel{" "}
          </button>
        </form>
      </div>
