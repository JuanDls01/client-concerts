...
const UserPanel = ({ userProp, profile = false }) => {
    ...
    const { updatePassword, updateUser, clearUpdateErr, updateProfile } = actionsCreator;
    ...
    const validatorPW = (input) => {
        let errors = {};
        if(!input.currentPassword && user.id === userProp.id) errors.currentPassword = "The current password is required";
